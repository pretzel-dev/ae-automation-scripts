(function(){
    ...
    // Use the provided correct expression.
    var expr = 
    'var pinPoint = effect("Pin Position")("Menu").value;\n' +
    'var pad = effect("Padding Value")("Slider").value;\n' +
    ...
    'var paddingCalc = (usePercent==1) ? [compSize[0]*(pad/100), compSize[1]*(pad/100)] : [pad, pad];\n' +
    ...
    for (var i = 0; i < selectedLayers.length; i++){
        ...
        // Rename the dropdown by renaming its parameter group.
        ...
        // Create or retrieve the "Padding Value" slider control.
        var padCtrl = effects.property("Padding Value");
        if (!padCtrl){
            padCtrl = effects.addProperty("ADBE Slider Control");
            padCtrl.name = "Padding Value";
        }
        padCtrl.property("Slider").setValue(0);
        
        // Create or retrieve the "Percent Based" checkbox control.
